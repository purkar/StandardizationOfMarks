...
<font face="Arial, Helvetica, sans-serif" color="#3333CC" size=2>(All Regions)</font>
    ...
    <h3 style="text-indent:4em"><a href="studentinfo.php"><pre><li>Students Information</li></pre></a></h3>
    <h3 style="text-indent:4em"><a href="marks.php"><pre><li>Students Marks</li></pre></a></h3>
    <h3 style="text-indent:4em"><a href="percentile.php"><pre><li>Students Percentile</li></pre></a></h3>
    <h3 style="text-indent:4em"> <a href="rank.php"><pre><li>Students Rank</li></pre></a></h3>
    <h3 style="text-indent:4em"> <a href="grade.php"><pre><li>Students Grade</li></pre></a></h3>
    <h3 style="text-indent:4em"> <a href="gradepoint.php"><pre><li>Students Gradepoint</li></pre></a></span></h3>
<h3 style="text-indent:4em"> <a href="cgpa.php"><pre><li>Students CGPA, Normalized Score, Merit Number + Comparison</li></pre></a></h3>
<h3 style="text-indent:4em"> <a href="statistics.php"><pre><li>Statistics</li></pre></a></h3>
<h3 style="text-indent:4em"> <a href="GradeDiv.php"><pre><li>Grades Corresponding To Percentiles</li></pre></a></h3>
<h3 style="text-indent:4em"> <a href="subwisecompare.php"><pre><li>Subject wise comparison</li></pre></a></h3>
...
<table width="100%">
  <tr bgcolor="#c2dbf8" align="middle" valign="baseline"> 
    ...
    {
         header("location:AdminPanel.php?Active=not_computed");
    }
    ?>