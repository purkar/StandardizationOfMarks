...
<style>
    ...
    <tr><td style="border: 2px solid black;" align="left">PHYSICS</td><td style="border: 2px solid black;" align="center"><?php echo  $PhyMark;?></td><td style="border: 2px solid black;" align="center"><?php echo  round($PhyPerc,4);  ?></td><td style="border: 2px solid black;" align="center"><?php if($PhyGrdPt>3) echo $PhyGrd; else echo "--";?> </td><td style="border: 2px solid black;" align="center"><?php if($PhyGrdPt>3) echo $PhyGrdPt; else echo "--";?></tr>
     <tr bgcolor="aliceblue"><td style="border: 2px solid black;" align="left">CHEMISTRY</td><td style="border: 2px solid black;" align="center"><?php echo $ChemMark;?></td><td style="border: 2px solid black;" align="center"><?php echo  round($ChemPerc,4);  ?></td><td style="border: 2px solid black;" align="center"><?php if($ChemGrdPt>3) echo $ChemGrd; else echo "--";?></td><td style="border: 2px solid black;" align="center"><?php if($ChemGrdPt>3) echo $ChemGrdPt; else echo "--";?></tr>
      <tr><td style="border: 2px solid black;" align="left">MATHEMATICS</td><td style="border: 2px solid black;" align="center"><?php echo $MathMark;?></td><td style="border: 2px solid black;" align="center"><?php echo  round($MathPerc,4)?></td><td style="border: 2px solid black;" align="center"><?php if($MathGrdPt>3) echo $MathGrd; else echo "--";?></td><td style="border: 2px solid black;" align="center"><?php if($MathGrdPt>3) echo $MathGrdPt; else echo "--";?></tr> 
      <tr bgcolor="aliceblue"><td style="border: 2px solid black;" align="left">ENGLISH</td><td style="border: 2px solid black;" align="center"><?php echo $EngMark;?></td><td style="border: 2px solid black;" align="center"><?php echo  round($EngPerc,4);  ?></td><td style="border: 2px solid black;" align="center"><?php if($EngGrdPt>3) echo $EngGrd; else echo "--";?></td><td style="border: 2px solid black;" align="center"><?php if($EngGrdPt>3) echo $EngGrdPt; else echo "--";?></tr>
        <tr><td style="border: 2px solid black;" align="left">COMPUTER</td><td style="border: 2px solid black;" align="center"><?php echo $CompMark;?></td><td style="border: 2px solid black;" align="center"><?php echo  round($CompPerc,4);  ?></td><td style="border: 2px solid black;" align="center"><?php if($CompGrdPt>3) echo $CompGrd; else echo "--";?></td><td style="border: 2px solid black;" align="center"><?php if($CompGrdPt>3) echo $CompGrdPt; else echo "--";?></tr>
        <tr style="background-color:rgb(55,58,190);" ><td bgcolor="white"></td><td bgcolor="white"></td><td  style="border: 2px solid black;" align="center" height="10px"><b><h style="color:white"><t>NORMALIZED SCORE: </t><?php if($CGP!=0) echo round($NORM,4); else echo "--";?></h></b></td><td bgcolor="white"></td><td  height="50" style="border: 2px solid black;" align="center"><b><font size="5" style="color:white">CGPA: <?php if($CGP!=0) echo $CGP; else echo "--";?></font></b></td></tr>
...
<?php              
    ...
    {
         header("location:index.php?login=not_computed");
    }
    ?>
    <br>
    <br>
