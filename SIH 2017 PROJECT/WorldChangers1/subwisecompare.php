...
<CENTER>
      <font face="Arial, Helvetica, sans-serif" color="#3333CC" size=6><b><u>Subject wise comparison</u></b></font><br><br>
    ...
    function Scorecard(&$conn)
    {
       ...
       $result = mysqli_query($conn,"SELECT * FROM `stud_data`");
        if ($result->num_rows>0) 
        {
         ...
         <thead style="background-color:rgb(55,58,190)"><td style="border:2px solid black;color:white">STUDENT ID</td><td style="border:2px solid black;color:white">PHYSICS PERCENTILE</td><td style="border:2px solid black;color:white">PHYSICS GRADE</td><td style="border:2px solid black;color:white">PHYSICS MARKS</td></thead>
         ...
         {
             ?>
          <tr align="center"><td style="border:2px solid black;"><?php echo $ID; ?></td><td style="border:2px solid black;"><?php echo round($PhyPerc,4);?></td><td style="border:2px solid black;"><?php echo $PhyGrd;?></td><td style="border:2px solid black;"><?php echo $PhyMark;?></td></tr>
      ...
      <?php
        ...
        ?>
              <tr align="center" bgcolor="aliceblue" ><td style="border:2px solid black;"><?php echo $ID; ?></td><td style="border:2px solid black;"><?php echo round($PhyPerc,4);?></td><td style="border:2px solid black;"><?php echo $PhyGrd;?></td><td style="border:2px solid black;"><?php echo $PhyMark;?></td></tr>
