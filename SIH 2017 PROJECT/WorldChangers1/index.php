...
if(isset($_GET["login"]))
{
    ...
    elseif($_GET["login"]=="not_computed")
      {
        echo "<script>document.getElementById('alerttext').innerHTML='<br><b>The Result is yet to be computed. Please contact your Administrator.</b>';</script>";
    }  
}
?>
 </div>
