...
function PhyGradeRange(&$conn)
{
    ...
    <table align="center" height="50px" style="width:90%; border-collapse:collapse;">
                <tr align="center"><td style="border: 3px solid black;"><b>PERCENTILE RANGE</b></td><td style="border: 3px solid black;"><?php echo round($GradDivs[0],4);?>-<?php echo round($GradDivs[1],4);?></td><td style="border: 3px solid black;"><?php echo round($GradDivs[1],4);?>-<?php echo round($GradDivs[2],4);?></td><td style="border: 3px solid black;"><?php echo round($GradDivs[2],4);?>-<?php echo round($GradDivs[3],4);?></td><td style="border: 3px solid black;"><?php echo round($GradDivs[3],4);?>-<?php echo round($GradDivs[4],4);?></td><td style="border: 3px solid black;"><?php echo round($GradDivs[4],4);?>-<?php echo round($GradDivs[5],4);?></td><td style="border: 3px solid black;"><?php echo round($GradDivs[5],4);?>-<?php echo round($GradDivs[6],4);?></td><td style="border: 3px solid black;"><?php echo round($GradDivs[6],4);?>-<?php echo round($GradDivs[7],4);?></td><td style="border: 3px solid black;"><?php echo round($GradDivs[7],4);?>-<?php echo round($GradDivs[8],4);?></td><td style="border: 3px solid black;"><?php echo round($GradDivs[8],4);?>-<?php echo round($GradDivs[9],4);?></td><td style="border: 3px solid black;"><?php echo round($GradDivs[9],4);?>-<?php echo round($GradDivs[10],4);?></td></tr>

        <tr align="center"><td style="border: 3px solid black;"><b>GRADE</b></td><td style="border: 3px solid black;">F3</td><td style="border: 3px solid black;">F2</td><td style="border: 3px solid black;">F1</td><td style="border: 3px solid black;">D</td><td style="border: 3px solid black;">C2</td><td style="border: 3px solid black;">C1</td><td style="border: 3px solid black;">B2</td><td style="border: 3px solid black;">B1</td><td style="border: 3px solid black;">A2</td><td style="border: 3px solid black;">A1</td></tr>
